...
export const ThemeToggle = ({ className }: { className?: ClassNameValue }) => {
  ...
  return (
    <Switch
      className={twMerge(
        "group inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 transition-colors duration-200 ease-in-out focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-hidden data-checked:bg-blue-600",
        className,
      )}
    ...
    >
      ...
      <span className="pointer-events-none relative inline-block h-5 w-5 transform rounded-full bg-white shadow-sm ring-0 transition duration-200 ease-in-out group-data-checked:translate-x-5 dark:bg-gray-700">
        <span
          aria-hidden="true"
